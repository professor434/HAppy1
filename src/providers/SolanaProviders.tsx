...
// ---- RPC από env με ασφαλές fallback (Extrnode) ----
...
const FALLBACK_WS   = "wss://solana-mainnet.rpc.extrnode.com/abba3bc7-b46a-4acb-8b15-834781a11ae2";
  ...
  return (
    <ConnectionProvider
      ...
      config={{
        ...
        wsEndpoint: WS,
        confirmTransactionInitialTimeout: 120_000, // πιο άνετο για mobile
      }}
    >
