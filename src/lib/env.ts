...
// Όλα από import.meta.env (Vite). ΜΗΝ χρησιμοποιείς process.env εδώ.
...
export const COMMITMENT: "processed" | "confirmed" | "finalized" = "processed"; // γρήγορο UI σε mobile :contentReference[oaicite:1]{index=1}
